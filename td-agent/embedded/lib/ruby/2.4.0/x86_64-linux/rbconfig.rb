...
module RbConfig
  ...
  CONFIG["EXEEXT"] = ""
  CONFIG["prefix"] = (TOPDIR || DESTDIR + "/opt/td-agent/embedded")
  ...
  CONFIG["configure_args"] = " '--prefix=/opt/td-agent/embedded' '--without-ext=dbm,gdbm,probe,racc,sdbm,tk' '--enable-shared' '--disable-install-doc' '--without-gmp' '--without-gdbm' '--without-tk' '--disable-dtrace' '--enable-libedit' '--with-opt-dir=/opt/td-agent/embedded' 'CFLAGS=-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe' 'LDFLAGS=-Wl,-rpath,/opt/td-agent/embedded/lib -L/opt/td-agent/embedded/lib' 'CPPFLAGS=-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe' 'CXXFLAGS=-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe'"
  ...
  CONFIG["RUBY_EXEC_PREFIX"] = "/opt/td-agent/embedded"
  ...
  CONFIG["STATIC"] = ""
  CONFIG["ARCH_FLAG"] = ""
  CONFIG["DLDFLAGS"] = "-Wl,-rpath,/opt/td-agent/embedded/lib -L/opt/td-agent/embedded/lib -Wl,--compress-debug-sections=zlib -L/opt/td-agent/embedded/lib  -Wl,-rpath,/opt/td-agent/embedded/lib"
  CONFIG["ALLOCA"] = ""
  CONFIG["codesign"] = ""
  CONFIG["POSTLINK"] = ":"
  ...
  CONFIG["CPP"] = "$(CC) -E"
  CONFIG["CXXFLAGS"] = "-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe"
  CONFIG["OBJEXT"] = "o"
  CONFIG["CPPFLAGS"] = "-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe -I/opt/td-agent/embedded/include $(DEFS) $(cppflags)"
  CONFIG["LDFLAGS"] = "-L. -Wl,-rpath,/opt/td-agent/embedded/lib -L/opt/td-agent/embedded/lib -fstack-protector -rdynamic -Wl,-export-dynamic -L/opt/td-agent/embedded/lib  -Wl,-rpath,/opt/td-agent/embedded/lib"
  CONFIG["CFLAGS"] = "-I/opt/td-agent/embedded/include -O2 -O3 -g -pipe -fPIC"
  CONFIG["CXX"] = "g++"
  CONFIG["CC"] = "gcc"
